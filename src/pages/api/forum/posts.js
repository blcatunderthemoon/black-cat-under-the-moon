...
import { awardForumPostShards, awardForumPostSoul } from '../../../lib/my-cat-awards.js';
import {
  VALID_POST_TOPICS,
  getTopicDbValues,
  isValidPostTopic,
...
async function handlePost(req, res) {
  ...
  awardForumPostSoul(admin, user.id, post.id).catch((err) => {
    console.error('[forum/posts] cat soul award failed:', err?.message || err);
  });
