...
const GUIDE_FAQS = {
  'hong-kong-les-guide': [
    ...
    },
    {
      ...
      answer: '可以由低壓方式開始：做性格測驗、睇指南、喺香港Les討論區（黑貓樹洞）觀察，或者用匿名漂流瓶傾訴，唔使一開始就公開身份。',
    },
    {
      question: '香港Les討論區同交友 App 有咩分別？',
      answer: '討論區偏重分享同交流；交友／配對平台偏重配對。黑貓樹洞係香港Les討論區，Echo Mode 係配對，兩者可以一齊用。',
    },
    {
      question: 'Black Cat Under The Moon 係咪只係交友 app？',
      answer: '唔止。除咗配對，仲有性格測驗、匿名漂流瓶同香港Les討論區（黑貓樹洞），重點係幫香港女同志認識自己同連結同路人。',
    },
  ],
};
