"use strict";(()=>{var a={};a.id=5364,a.ids=[5364],a.modules={12642:(a,b,c)=>{c.a(a,async(a,d)=>{try{c.r(b),c.d(b,{default:()=>l});var e=c(21572),f=c.n(e),g=c(93721),h=c(81654),i=c(58288),j=c(79898),k=a([g,j]);[g,j]=k.then?(await k)():k;let m=(0,g.createClient)(process.env.SUPABASE_URL||"https://axlkrmcgtubuaavlbvgh.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY||process.env.SUPABASE_ANON_KEY||"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF4bGtybWNndHVidWFhdmxidmdoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzU2NjQxMTgsImV4cCI6MjA5MTI0MDExOH0.oaDYixsSlAkPBpLw-ZRquX8RgOa6F0OHUXVUEW6APKY",{auth:{persistSession:!1}});async function l(a,b){if("POST"!==a.method)return b.status(405).json({error:"Method not allowed. Use POST."});if(!process.env.GMAIL_USER||!process.env.GMAIL_APP_PASSWORD)return b.status(503).json({error:"Email sending is not configured yet.",hint:"Add GMAIL_USER and GMAIL_APP_PASSWORD to your .env.local, then restart the dev server."});process.env.SUPABASE_URL;let{pairs:c}="string"==typeof a.body?JSON.parse(a.body||"{}"):a.body||{};if(!Array.isArray(c)||0===c.length)return b.status(400).json({error:"pairs must be a non-empty array."});for(let a of c){let c=Number(a.userAId),d=Number(a.userBId);if(!c||!d||c===d||!Number.isInteger(c)||!Number.isInteger(d))return b.status(400).json({error:`Invalid pair: ${JSON.stringify(a)}`})}let d=[...new Set(c.flatMap(a=>[Number(a.userAId),Number(a.userBId)]))],{data:e,error:g}=await m.from("responses").select("*").in("id",d);if(g)return b.status(500).json({error:g.message});let k=Object.fromEntries((e||[]).map(a=>[Number(a.id),a])),l=f().createTransport({host:"smtp.gmail.com",port:587,secure:!1,auth:{user:process.env.GMAIL_USER,pass:process.env.GMAIL_APP_PASSWORD}}),n=[];for(let a of c){let b=Number(a.userAId),c=Number(a.userBId),d=k[b],e=k[c];if(!d||!e){n.push({userAId:b,userBId:c,error:"User not found"});continue}let f=(0,i.c)(d,e),g=Math.max(0,Math.min(100,Math.round(f.finalScore||Number(a.match_score)||0))),o=[];for(let[a,b]of[[d,e],[e,d]]){if(!a.email){o.push({to:a.id,skipped:!0,reason:"No email address"});continue}try{let c=(0,j.buildMatchCardHtml)({user:a,target:b,score:g,breakdown:f.dimensionScores||{},intelligence:f}),d=String(a.name).replace(/[^\w\u4e00-\u9fff]/g,"_"),e=String(b.name).replace(/[^\w\u4e00-\u9fff]/g,"_");await l.sendMail({from:`"Black Cat Under The Moon" <${process.env.GMAIL_USER}>`,to:a.email,subject:`你與 ${b.name} 配對成功 ✨ | Black Cat Under The Moon`,html:(0,h.Mr)({receiver:a,partner:b,score:g}),text:(0,h.Ez)({receiver:a,partner:b,score:g}),attachments:[{filename:`配對卡_${d}_x_${e}.html`,content:c,contentType:"text/html; charset=utf-8"}]}),o.push({to:a.id,delivered:!0})}catch(b){o.push({to:a.id,delivered:!1,error:b.message})}}let[p,q]=b<=c?[b,c]:[c,b],r=o.some(a=>a.delivered);await m.from("sent_matches").upsert({user_a_id:p,user_b_id:q,match_score:g,notes:r?"自動記錄（郵件已送出）":"自動記錄（郵件發送失敗）"},{onConflict:"user_a_id,user_b_id",ignoreDuplicates:!1}),await m.from("email_drafts").delete().eq("user_a_id",p).eq("user_b_id",q),n.push({userAId:b,userBId:c,score:g,deliveries:o,recorded:!0})}return b.status(200).json({success:!0,results:n})}d()}catch(a){d(a)}})},14160:(a,b,c)=>{c.a(a,async(a,d)=>{try{c.r(b),c.d(b,{config:()=>o,default:()=>n,handler:()=>m});var e=c(29046),f=c(8667),g=c(33480),h=c(86435),i=c(12642),j=c(58112),k=c(18766),l=a([i]);i=(l.then?(await l)():l)[0];let n=(0,h.M)(i,"default"),o=(0,h.M)(i,"config"),p=new g.PagesAPIRouteModule({definition:{kind:f.A.PAGES_API,page:"/api/dashboard/send-emails",pathname:"/api/dashboard/send-emails",bundlePath:"",filename:""},userland:i,distDir:".next",relativeProjectDir:""});async function m(a,b,c){let d=await p.prepare(a,b,{srcPage:"/api/dashboard/send-emails"});if(!d){b.statusCode=400,b.end("Bad Request"),null==c.waitUntil||c.waitUntil.call(c,Promise.resolve());return}let{query:f,params:g,prerenderManifest:h,routerServerContext:i}=d;try{let c=a.method||"GET",d=(0,j.getTracer)(),e=d.getActiveScopeSpan(),l=p.instrumentationOnRequestError.bind(p),m=async e=>p.render(a,b,{query:{...f,...g},params:g,allowedRevalidateHeaderKeys:[],multiZoneDraftMode:!1,trustHostHeader:!1,previewProps:h.preview,propagateError:!1,dev:p.isDev,page:"/api/dashboard/send-emails",internalRevalidate:null==i?void 0:i.revalidate,onError:(...b)=>l(a,...b)}).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":b.statusCode,"next.rsc":!1});let f=d.getRootSpanAttributes();if(!f)return;if(f.get("next.span_type")!==k.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${f.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let g=f.get("next.route");if(g){let a=`${c} ${g}`;e.setAttributes({"next.route":g,"http.route":g,"next.span_name":a}),e.updateName(a)}else e.updateName(`${c} ${a.url}`)});e?await m(e):await d.withPropagatedContext(a.headers,()=>d.trace(k.BaseServerSpan.handleRequest,{spanName:`${c} ${a.url}`,kind:j.SpanKind.SERVER,attributes:{"http.method":c,"http.target":a.url}},m))}catch(a){if(p.isDev)throw a;(0,e.sendError)(b,500,"Internal Server Error")}finally{null==c.waitUntil||c.waitUntil.call(c,Promise.resolve())}}d()}catch(a){d(a)}})},21572:a=>{a.exports=require("nodemailer")},75600:a=>{a.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},81654:(a,b,c)=>{function d(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}c.d(b,{Ez:()=>h,Mr:()=>g});let e=`
    <!-- Safety reminder -->
